...
type UserServiceClient interface {
	...
	EditProfile(ctx context.Context, in *EditProfileReqBpdy, opts ...grpc.CallOption) (*UserRes, error)
...
func (c *userServiceClient) EditProfile(ctx context.Context, in *EditProfileReqBpdy, opts ...grpc.CallOption) (*UserRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserRes)
...
type UserServiceServer interface {
	...
	EditProfile(context.Context, *EditProfileReqBpdy) (*UserRes, error)
...
func (UnimplementedUserServiceServer) EditProfile(context.Context, *EditProfileReqBpdy) (*UserRes, error) {
...
func _UserService_EditProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).EditProfile(ctx, req.(*EditProfileReqBpdy))
	}
	return interceptor(ctx, in, info, handler)
}
